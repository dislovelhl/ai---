...
from .routers import skills, workflows, executions, chat, analytics, collaboration, workflow_categories, workflow_tags
...
app.include_router(workflow_tags.router, prefix="/v1/workflow-tags", tags=["Workflow Tags"])
